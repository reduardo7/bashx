...
@@assert._testAssertFail() { # INTERNAL
  ...
  @print "    - STD OUT:         [$([ -f "${ASSERTION_EXEC_OUT_STD}" ] && cat "${ASSERTION_EXEC_OUT_STD}")]"
  @print "    - ERR OUT:         [$([ -f "${ASSERTION_EXEC_OUT_ERR}" ] && cat "${ASSERTION_EXEC_OUT_ERR}")]"
  @print "    - INFO OUT:        [$([ -f "${ASSERTION_EXEC_OUT_INF}" ] && cat "${ASSERTION_EXEC_OUT_INF}")]"
